...
## Release Notes
- 2026-02-21: Notifications SQL V1 (schema + endpoints + backfill script + decommission/gate dokümanları). Alembic migration oluşturuldu; lokal DB offline olduğu için upgrade beklemede.
