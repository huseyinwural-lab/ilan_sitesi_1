...
**Son güncelleme:** 2026-02-20 (Başvuru Modülü RDBMS + admin assign/status + Postgres bağlantı notu + UI güncelleme)
...
- 2026-02-20: Preview ortamında DATABASE_URL (Postgres) erişimi yok; applications API 503 döner (E2E için bağlantı sağlanmalı)
