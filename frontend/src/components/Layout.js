...
export default function Layout({ children }) {
  ...
  { path: '/admin/individual-applications', icon: Clock, label: 'Bireysel Üye Başvurular', roles: roles.userOps, testId: 'members-individual-applications' },
    ...
    { path: '/admin/listings', icon: FileText, label: 'Tüm İlanlar', roles: roles.moderation, testId: 'listings-all' },
    { path: '/admin/listings/paid', icon: FileText, label: 'Ücretli İlanlar', roles: roles.moderation, testId: 'listings-paid' },
    { path: '/admin/listings/featured', icon: FileText, label: 'Vitrin İlanlar', roles: roles.moderation, testId: 'listings-featured' },
    { path: '/admin/listings/urgent', icon: FileText, label: 'Acil İlanlar', roles: roles.moderation, testId: 'listings-urgent' },
