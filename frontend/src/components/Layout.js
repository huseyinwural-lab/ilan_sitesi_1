...
import { 
  ...
  Building, Star, ShieldCheck, FileText, Percent, Car, TrendingUp, Activity, Sparkles, Layers, Package, PanelTop, Palette, UploadCloud
} from 'lucide-react';
...
export default function Layout({ children }) {
  ...
  { path: '/admin/individual-applications', icon: Clock, label: 'Bireysel Üye Başvurular', roles: roles.userOps, testId: 'members-individual-applications' },
    ...
    { path: '/admin/listings', icon: FileText, label: 'Onaylı Tüm İlanlar', roles: roles.moderation, testId: 'listings-all-approved' },
  ...
  { path: '/admin/pricing/packages', icon: Package, label: 'Kurumsal Kampanyalar', roles: roles.pricingManager, testId: 'pricing-corporate-campaigns' },
    ...
    { path: '/admin/preset-runs', icon: Activity, label: 'Preset Run History', roles: roles.adminOnly, testId: 'site-design-preset-runs' },
    { path: '/admin/revision-redirect-telemetry', icon: Activity, label: 'Revision Redirect Telemetry', roles: roles.adminOnly, testId: 'site-design-revision-redirect-telemetry' },
    ...
    { path: '/admin/release-retention', icon: Activity, label: 'Release Retention', roles: roles.opsReliability, testId: 'ops-release-retention' },
    ...
    { path: '/admin/dealer-portal-config', icon: Building, label: 'Kurumsal Menü Yönetimi', roles: roles.adminOnly, testId: 'catalog-dealer-portal-config' },
  ...
  const isAdminPathDisabled = (path) => {
    ...
    const known = new Set([
      ...
      '/admin/individual-listing-applications/paid',
      '/admin/individual-listing-applications/featured',
      '/admin/individual-listing-applications/urgent',
      '/admin/corporate-listing-applications',
      '/admin/corporate-listing-applications/paid',
      '/admin/corporate-listing-applications/featured',
      ...
      '/admin/preset-runs',
      '/admin/revision-redirect-telemetry',
      '/admin/user-interface-design',
      '/admin/ops/publish-health',
      '/admin/release-retention',
      '/admin/info-pages',
      '/admin/dashboard',
      ...
      '/admin/listings',
      '/admin/listings/paid',
      '/admin/listings/featured',
      '/admin/listings/urgent',
      '/admin/invoices',
      '/admin/tax-rates',
      '/admin/plans',
      '/admin/dealers',
