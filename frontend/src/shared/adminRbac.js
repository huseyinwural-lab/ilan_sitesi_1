...
export const ADMIN_ROUTE_RULES = [
  ...
  { pattern: /^\/admin\/listings(?:\/(featured|urgent))?$/, roles: ADMIN_ROLE_GROUPS.moderation },
  { pattern: /^\/admin\/individual-listing-applications(?:\/(featured|urgent))?$/, roles: ADMIN_ROLE_GROUPS.moderation },
  { pattern: /^\/admin\/corporate-listing-applications(?:\/(featured|urgent))?$/, roles: ADMIN_ROLE_GROUPS.moderation },
