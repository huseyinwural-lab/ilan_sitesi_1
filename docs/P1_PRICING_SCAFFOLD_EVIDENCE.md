...
**Komut:**
```bash
curl -s -X GET "https://listing-design-draft.preview.emergentagent.com/api/admin/pricing/campaign" \
...
**Komut:**
```bash
curl -s -X PUT "https://listing-design-draft.preview.emergentagent.com/api/admin/pricing/campaign" \
  -H "Authorization: Bearer <TOKEN>" \
...
**Komut:**
```bash
curl -s -X POST "https://listing-design-draft.preview.emergentagent.com/api/pricing/quote" \
  -H "Content-Type: application/json" \
...
**Komut:**
```bash
curl -s -X GET "https://listing-design-draft.preview.emergentagent.com/api/pricing/packages"
```
**Çıktı:**
```json
