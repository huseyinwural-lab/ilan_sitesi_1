...
**Komut:**
```bash
curl -s -X GET "https://corporate-campaigns.preview.emergentagent.com/api/admin/pricing/campaign" \
...
**Komut:**
```bash
curl -s -X PUT "https://corporate-campaigns.preview.emergentagent.com/api/admin/pricing/campaign" \
  -H "Authorization: Bearer <TOKEN>" \
...
**Komut:**
```bash
curl -s -X GET "https://corporate-campaigns.preview.emergentagent.com/api/pricing/packages"
```
**Çıktı:**
```json
