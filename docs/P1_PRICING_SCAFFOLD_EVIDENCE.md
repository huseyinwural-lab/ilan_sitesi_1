...
**Komut:**
```bash
curl -s -X GET "https://feature-complete-36.preview.emergentagent.com/api/admin/pricing/campaign" \
...
**Komut:**
```bash
curl -s -X PUT "https://feature-complete-36.preview.emergentagent.com/api/admin/pricing/campaign" \
  -H "Authorization: Bearer <TOKEN>" \
...
**Komut:**
```bash
curl -s -X GET "https://feature-complete-36.preview.emergentagent.com/api/pricing/packages"
```
**Çıktı:**
```json
