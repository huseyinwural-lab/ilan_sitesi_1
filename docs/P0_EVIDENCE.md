...
**Komut:**
```bash
curl -s "https://post-ad-mvp.preview.emergentagent.com/api/health"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s "https://post-ad-mvp.preview.emergentagent.com/api/health/db"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s -X POST "https://post-ad-mvp.preview.emergentagent.com/api/auth/login" \
...
**Komut:**
```bash
curl -s -X GET "https://post-ad-mvp.preview.emergentagent.com/api/admin/session/health" \
