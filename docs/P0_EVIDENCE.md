...
**Komut:**
```bash
curl -s "https://admin-categories-2.preview.emergentagent.com/api/health"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s "https://admin-categories-2.preview.emergentagent.com/api/health/db"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s -X POST "https://admin-categories-2.preview.emergentagent.com/api/auth/login" \
...
**Komut:**
```bash
curl -s -X GET "https://admin-categories-2.preview.emergentagent.com/api/admin/session/health" \
