...
**Komut:**
```bash
curl -s "https://layout-uniqueness.preview.emergentagent.com/api/health"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s "https://layout-uniqueness.preview.emergentagent.com/api/health/db"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s -X POST "https://layout-uniqueness.preview.emergentagent.com/api/auth/login" \
...
**Komut:**
```bash
curl -s -X GET "https://layout-uniqueness.preview.emergentagent.com/api/admin/session/health" \
