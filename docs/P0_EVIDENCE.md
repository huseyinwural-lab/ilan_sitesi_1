...
**Komut:**
```bash
curl -s "https://feature-complete-36.preview.emergentagent.com/api/health"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s "https://feature-complete-36.preview.emergentagent.com/api/health/db"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s -X POST "https://feature-complete-36.preview.emergentagent.com/api/auth/login" \
...
**Komut:**
```bash
curl -s -X GET "https://feature-complete-36.preview.emergentagent.com/api/admin/session/health" \
