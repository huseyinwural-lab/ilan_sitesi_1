...
**Komut:**
```bash
curl -s "https://builder-hub-151.preview.emergentagent.com/api/health"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s "https://builder-hub-151.preview.emergentagent.com/api/health/db"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s -X POST "https://builder-hub-151.preview.emergentagent.com/api/auth/login" \
...
**Komut:**
```bash
curl -s -X GET "https://builder-hub-151.preview.emergentagent.com/api/admin/session/health" \
