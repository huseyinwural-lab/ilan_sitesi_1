...
**Komut:**
```bash
curl -s "https://monolith-modular-5.preview.emergentagent.com/api/health"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s "https://monolith-modular-5.preview.emergentagent.com/api/health/db"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s -X POST "https://monolith-modular-5.preview.emergentagent.com/api/auth/login" \
...
**Komut:**
```bash
curl -s -X GET "https://monolith-modular-5.preview.emergentagent.com/api/admin/session/health" \
