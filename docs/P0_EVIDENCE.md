...
**Komut:**
```bash
curl -s "https://billing-cleanup.preview.emergentagent.com/api/health"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s "https://billing-cleanup.preview.emergentagent.com/api/health/db"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s -X POST "https://billing-cleanup.preview.emergentagent.com/api/auth/login" \
...
**Komut:**
```bash
curl -s -X GET "https://billing-cleanup.preview.emergentagent.com/api/admin/session/health" \
