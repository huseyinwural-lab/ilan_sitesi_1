...
**Komut:**
```bash
curl -s "https://marketplace-finance-3.preview.emergentagent.com/api/health"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s "https://marketplace-finance-3.preview.emergentagent.com/api/health/db"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s -X POST "https://marketplace-finance-3.preview.emergentagent.com/api/auth/login" \
...
**Komut:**
```bash
curl -s -X GET "https://marketplace-finance-3.preview.emergentagent.com/api/admin/session/health" \
