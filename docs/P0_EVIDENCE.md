...
**Komut:**
```bash
curl -s "https://marketplace-admin-13.preview.emergentagent.com/api/health"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s "https://marketplace-admin-13.preview.emergentagent.com/api/health/db"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s -X POST "https://marketplace-admin-13.preview.emergentagent.com/api/auth/login" \
...
**Komut:**
```bash
curl -s -X GET "https://marketplace-admin-13.preview.emergentagent.com/api/admin/session/health" \
