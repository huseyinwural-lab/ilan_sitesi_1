...
**Komut:**
```bash
curl -s "https://panel-manual-tr.preview.emergentagent.com/api/health"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s "https://panel-manual-tr.preview.emergentagent.com/api/health/db"
```
**Çıktı:**
```json
...
**Komut:**
```bash
curl -s -X POST "https://panel-manual-tr.preview.emergentagent.com/api/auth/login" \
...
**Komut:**
```bash
curl -s -X GET "https://panel-manual-tr.preview.emergentagent.com/api/admin/session/health" \
