...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://header-config-1.preview.emergentagent.com').rstrip('/')
...
class TestHttpToHttpsRedirect:
    ...
    def test_https_no_redirect(self):
        ...
        https_url = "https://header-config-1.preview.emergentagent.com/"
