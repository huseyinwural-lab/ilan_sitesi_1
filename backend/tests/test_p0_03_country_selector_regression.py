...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://billing-cleanup.preview.emergentagent.com').rstrip('/')
...
class TestHttpToHttpsRedirect:
    ...
    def test_https_no_redirect(self):
        ...
        https_url = "https://billing-cleanup.preview.emergentagent.com/"
