...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://marketplace-admin-13.preview.emergentagent.com').rstrip('/')
...
class TestHttpToHttpsRedirect:
    ...
    def test_https_no_redirect(self):
        ...
        https_url = "https://marketplace-admin-13.preview.emergentagent.com/"
