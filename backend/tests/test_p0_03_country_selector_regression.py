...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://panel-manual-tr.preview.emergentagent.com').rstrip('/')
...
class TestHttpToHttpsRedirect:
    ...
    def test_https_no_redirect(self):
        ...
        https_url = "https://panel-manual-tr.preview.emergentagent.com/"
