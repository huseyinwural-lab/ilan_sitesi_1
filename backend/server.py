...
from sqlalchemy import select, func, case, distinct, String, Text, DateTime, ForeignKey, desc, asc, and_, or_, update, text, cast, event
...
VEHICLE_IMPORT_JOB_TIMEOUT_SECONDS = 30 * 60
VEHICLE_IMPORT_BATCH_SIZE = 200
