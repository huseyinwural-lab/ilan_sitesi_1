...
async def lifespan(app: FastAPI):
    ...
    await db.favorites.create_index("listing_id")
    await db.message_threads.create_index("participants")
    await db.message_threads.create_index("listing_id")
    await db.message_threads.create_index("last_message_at")
